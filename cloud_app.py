...
async function sendAll(){
  ...
  if(_gmailMode==='browser'){
    ...
    let opened=0;
    for(const row of s){
      const subject=`Rebate Debit Note ${row.dn_number||''} - DH Store 